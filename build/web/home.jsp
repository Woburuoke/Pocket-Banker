            ...
            <div class="row  mx-4 my-4" >
                ...
                <div class="col-12 col-sm-8 col-md-8 col-lg-4 bg-info mb-5" style="border-radius: 30px; max-width: 25rem">
                    <div  class="py-3 py-lg-3" >
                        <span class="d-block fs-6 pb-3  pt-1 px-md-4">${advert2.header_text}</span>

                        <span class="d-block fs-3 pb-3 pt-3 px-md-4">${advert2.main_text}</span>


                        <span class="d-block fs-6 pb-2 pt-3 px-md-4">${advert2.description}</span>
                    </div>
                </div>    
